...
class RegisterNewUser(unittest.TestCase):
    ...
    def test_new_user(self):
        ...
        self.assertTrue(first_name.is_enabled() and last_name.is_enabled()
                         ...
                         and passsword.is_enabled()
                         and confirm_password.is_enabled()
                         and submit_button.is_enabled())
        #simula presionar teclas en un elemento
        first_name.send_keys('Jeison')
        driver.implicitly_wait(1)
        middle_name.send_keys('Test')
        driver.implicitly_wait(1)
        last_name.send_keys('Angel')
        driver.implicitly_wait(1)
        email_address.send_keys('jeison@prueba.com')
        driver.implicitly_wait(1)
        passsword.send_keys('jeison123')
        driver.implicitly_wait(1)
        passsword.send_keys('jeison123')
        driver.implicitly_wait(1)
        submit_button.click()
